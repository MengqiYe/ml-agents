...
from mlagents.trainers.pt.components.reward_providers.extrinsic_reward_provider import (
    ExtrinsicRewardProvider,
)
from mlagents.trainers.pt.components.reward_providers.curiosity_reward_provider import (
    CuriosityRewardProvider,
)
from mlagents.trainers.pt.components.reward_providers.gail_reward_provider import (
    GAILRewardProvider,
)
from mlagents.trainers.pt.components.reward_providers.rnd_reward_provider import (
    RNDRewardProvider,
)
