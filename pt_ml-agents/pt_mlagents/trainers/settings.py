...
from pt_mlagents.trainers.cli_utils import StoreConfigFile, DetectDefault, parser
from pt_mlagents.trainers.cli_utils import load_config
from pt_mlagents.trainers.exception import TrainerConfigError, TrainerConfigWarning
from pt_mlagents.trainers.models import ScheduleType, EncoderType
...
class RunOptions(ExportableSettings):
    ...
    def from_argparse(args: argparse.Namespace) -> "RunOptions":
        ...
        :param args: collection of command-line parameters passed to pt_mlagents-learn
