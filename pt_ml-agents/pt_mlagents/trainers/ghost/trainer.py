...
from pt_mlagents.trainers.stats import StatsPropertyType
from pt_mlagents.trainers.behavior_id_utils import (
    BehaviorIdentifiers,
...
class GhostTrainer(Trainer):
    ...
    def __init__(
        ...
        self.policies: Dict[str, PTPolicy] = {}
    ...
    def advance(self) -> None:
        ...
        for brain_name in self._internal_policy_queues:
            ...
            try:
                policy = cast(PTPolicy, internal_policy_queue.get_nowait())
