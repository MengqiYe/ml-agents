...
import pytest
import pt_mlagents.trainers.tests.mock_brain as mb
from pt_mlagents.trainers.trainer.rl_trainer import RLTrainer
from pt_mlagents.trainers.tests.test_buffer import construct_fake_buffer
...
@mock.patch("pt_mlagents.trainers.trainer.rl_trainer.RLTrainer._clear_update_buffer")
...
@mock.patch("pt_mlagents.trainers.trainer.trainer.Trainer.save_model")
@mock.patch("pt_mlagents.trainers.trainer.trainer.StatsReporter.write_stats")
