...
@mock.patch("pt_mlagents.tf_utils.pt.Summary")
@mock.patch("pt_mlagents.tf_utils.pt.summary.FileWriter")
...
class ConsoleWriterTest(unittest.TestCase):
    def test_console_writer(self):
        # Test write_stats
        with self.assertLogs("pt_mlagents.trainers", level="INFO") as cm:
            category = "category1"
