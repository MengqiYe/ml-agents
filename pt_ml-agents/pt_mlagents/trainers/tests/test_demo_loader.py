...
from pt_mlagents.trainers.tests.mock_brain import (
    create_mock_3dball_behavior_specs,
    setup_test_behavior_specs,
)
from pt_mlagents.trainers.demo_loader import (
    load_demonstration,
    demo_to_buffer,
    get_demo_files,
    write_delimited,
...
@mock.patch("pt_mlagents.trainers.demo_loader.get_demo_files", return_value=["foo.demo"])
