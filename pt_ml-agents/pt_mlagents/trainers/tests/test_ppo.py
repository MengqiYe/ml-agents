...
from pt_mlagents.trainers.ppo.trainer import PPOTrainer, discount_rewards
...
from pt_mlagents.trainers.tests import mock_brain as mb
from pt_mlagents.trainers.tests.test_trajectory import make_fake_trajectory
from pt_mlagents.trainers.settings import NetworkSettings
from pt_mlagents.trainers.tests.test_simple_rl import PPO_CONFIG
from pt_mlagents.trainers.tests.test_reward_signals import (  # noqa: F401; pylint: disable=unused-variable
...
def _create_ppo_optimizer_ops_mock(dummy_config, use_rnn, use_discrete, use_visual):
    ...
    policy = NNPolicy(
        0, mock_specs, trainer_settings, False, "test", False, create_pt_graph=False
    )
...
@mock.patch("pt_mlagents.trainers.ppo.trainer.PPOOptimizer")
