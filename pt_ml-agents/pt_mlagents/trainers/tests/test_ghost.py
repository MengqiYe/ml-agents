...
from pt_mlagents.trainers.ghost.trainer import GhostTrainer
...
from pt_mlagents.trainers.settings import TrainerSettings, SelfPlaySettings
...
def test_load_and_set(dummy_config, use_discrete):
    ...
    to_load_policy.create_pt_graph()
