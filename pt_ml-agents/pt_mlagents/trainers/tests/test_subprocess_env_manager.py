...
from pt_mlagents.trainers.subprocess_env_manager import (
    SubprocessEnvManager,
    EnvironmentResponse,
    StepResponse,
    EnvironmentCommand,
)
from pt_mlagents.trainers.env_manager import EnvironmentStep
from pt_mlagents_envs.base_env import BaseEnv
from pt_mlagents_envs.side_channel.engine_configuration_channel import EngineConfig
...
from pt_mlagents.trainers.tests.simple_test_envs import SimpleEnvironment
from pt_mlagents.trainers.stats import StatsReporter
from pt_mlagents.trainers.agent_processor import AgentManagerQueue
from pt_mlagents.trainers.tests.test_simple_rl import (
...
class SubprocessEnvManagerTest(unittest.TestCase):
    @mock.patch(
        "pt_mlagents.trainers.subprocess_env_manager.SubprocessEnvManager.create_worker"
    )
    ...
    @mock.patch("pt_mlagents.trainers.subprocess_env_manager.SubprocessEnvManager._step")
    @mock.patch(
        "pt_mlagents.trainers.subprocess_env_manager.SubprocessEnvManager.training_behaviors",
