...
from pt_mlagents.trainers.tests.mock_brain import setup_test_behavior_specs
from pt_mlagents.trainers.tests.test_trajectory import make_fake_trajectory
from pt_mlagents.trainers.tests.test_simple_rl import SAC_CONFIG
...
@mock.patch("pt_mlagents.trainers.sac.trainer.SACOptimizer")
