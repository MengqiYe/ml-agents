...
# source: pt_mlagents_envs/communicator_objects/header.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pt_mlagents_envs/communicator_objects/header.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\n/pt_mlagents_envs/communicator_objects/header.proto\x12\x14\x63ommunicator_objects\".\n\x0bHeaderProto\x12\x0e\n\x06status\x18\x01 \x01(\x05\x12\x0f\n\x07message\x18\x02 \x01(\tB%\xaa\x02\"Unity.MLAgents.CommunicatorObjectsb\x06proto3')
)
...
HeaderProto = _reflection.GeneratedProtocolMessageType('HeaderProto', (_message.Message,), dict(
  ...
  __module__ = 'pt_mlagents_envs.communicator_objects.header_pb2'
