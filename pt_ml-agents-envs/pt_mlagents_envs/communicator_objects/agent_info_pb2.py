...
# source: pt_mlagents_envs/communicator_objects/agent_info.proto
...
AgentInfoProto = _reflection.GeneratedProtocolMessageType('AgentInfoProto', (_message.Message,), dict(
  ...
  __module__ = 'pt_mlagents_envs.communicator_objects.agent_info_pb2'
