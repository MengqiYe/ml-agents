...
# source: pt_mlagents_envs/communicator_objects/agent_action.proto
...
AgentActionProto = _reflection.GeneratedProtocolMessageType('AgentActionProto', (_message.Message,), dict(
  ...
  __module__ = 'pt_mlagents_envs.communicator_objects.agent_action_pb2'
