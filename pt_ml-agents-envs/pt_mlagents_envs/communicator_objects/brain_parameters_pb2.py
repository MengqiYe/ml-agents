...
# source: pt_mlagents_envs/communicator_objects/brain_parameters.proto
...
BrainParametersProto = _reflection.GeneratedProtocolMessageType('BrainParametersProto', (_message.Message,), dict(
  ...
  __module__ = 'pt_mlagents_envs.communicator_objects.brain_parameters_pb2'
