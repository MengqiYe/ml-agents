...
# source: pt_mlagents_envs/communicator_objects/custom_reset_parameters.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pt_mlagents_envs/communicator_objects/custom_reset_parameters.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\n@pt_mlagents_envs/communicator_objects/custom_reset_parameters.proto\x12\x14\x63ommunicator_objects\"\x1c\n\x1a\x43ustomResetParametersProtoB%\xaa\x02\"Unity.MLAgents.CommunicatorObjectsb\x06proto3')
)
...
CustomResetParametersProto = _reflection.GeneratedProtocolMessageType('CustomResetParametersProto', (_message.Message,), dict(
  ...
  __module__ = 'pt_mlagents_envs.communicator_objects.custom_reset_parameters_pb2'
