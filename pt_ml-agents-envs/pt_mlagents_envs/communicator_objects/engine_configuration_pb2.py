...
# source: pt_mlagents_envs/communicator_objects/engine_configuration.proto
...
EngineConfigurationProto = _reflection.GeneratedProtocolMessageType('EngineConfigurationProto', (_message.Message,), dict(
  ...
  __module__ = 'pt_mlagents_envs.communicator_objects.engine_configuration_pb2'
