...
# source: pt_mlagents_envs/communicator_objects/capabilities.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pt_mlagents_envs/communicator_objects/capabilities.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_pb=_b('\n5pt_mlagents_envs/communicator_objects/capabilities.proto\x12\x14\x63ommunicator_objects\"6\n\x18UnityRLCapabilitiesProto\x12\x1a\n\x12\x62\x61seRLCapabilities\x18\x01 \x01(\x08\x42%\xaa\x02\"Unity.MLAgents.CommunicatorObjectsb\x06proto3')
)
...
UnityRLCapabilitiesProto = _reflection.GeneratedProtocolMessageType('UnityRLCapabilitiesProto', (_message.Message,), dict(
  ...
  __module__ = 'pt_mlagents_envs.communicator_objects.capabilities_pb2'
