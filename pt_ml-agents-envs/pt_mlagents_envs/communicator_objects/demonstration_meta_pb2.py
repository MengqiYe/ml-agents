...
# source: pt_mlagents_envs/communicator_objects/demonstration_meta.proto
...
DemonstrationMetaProto = _reflection.GeneratedProtocolMessageType('DemonstrationMetaProto', (_message.Message,), dict(
  ...
  __module__ = 'pt_mlagents_envs.communicator_objects.demonstration_meta_pb2'
